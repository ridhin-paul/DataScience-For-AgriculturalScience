...
It seems as though manure treatment is associated with improved soil properties which are positively correlated with YIELD, except for EC and NO~3,~ which seem to be poorly correlated. Tilage seems to have a very little to no impact on YIELD.
